...
const Card = () => {
  ...
  return (
    <div>
        <h2 className='text-center text-2xl mt-20 mb-10 font-bold'>Choice your studio</h2>
...
<div class="bg-neutral-primary-soft block max-w-sm border border-default rounded-base shadow-xs">
    ...
    <div class="p-6 text-center">
        ...
        <a href="#">
            <h5 class="mt-3 mb-6 text-2xl font-semibold tracking-tight text-heading">music studio</h5>
        </a>
